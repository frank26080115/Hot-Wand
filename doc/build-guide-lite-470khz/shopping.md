...
Quantity: **one #4-40-by-1/2-inch screw**. It passes through the shoulder washer, Q1, thermal pad, and heatsink stack shown in the build guide. Buy a small pack from [Amazon](https://www.amazon.com/s?k=%234-40+x+1%2F2+machine+screws), or use a local hardware store.
